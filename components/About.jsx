...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <div>
      <div className="hidden lg:flex w-full green-pink-gradient p-[1px] rounded-[20px] shadow-xl shadow-gray-400">
        <div
          option={{
            max: 45,
            scale: 1,
      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-2 gap-8">
        <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="md:pr-12">
            ...
            <p
              className="mb-2 py-2 text-gray-600 text-[17px] leading-[30px]"
              style={{ maxWidth: "30em" }}
            >
            ...
            <p className="mb-2 py-2 text-gray-600 text-[17px] leading-[30px]">
          ...
          <div className="col-span-2 md:grid grid-cols-2 gap-8">
